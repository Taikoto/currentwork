...
printf("___%p %p %d\n",mbuf,sbuf, len );
    memcpy(outputFilename, OUT_PICTURE_PATH, 15);
    memcpy(output2Filename, O22_PICTURE_PATH, 15);
    memcpy(inputFilename, INPUT_PICTURE_PATH, 13);
    memcpy(srcFilename, SRC_PICTURE_PATH, 13);
